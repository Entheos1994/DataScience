...
def ranked_result_of_ingredient():
    with open('/datasets/bbcHealthy.json', 'r') as stream:
...
def write_ranking_result():
    json.dump(ranked_result_of_ingredient(), open('/datasets/ingredients_ranking_healthybbc.json','w'))
...
def write_ranking_result_goodfood():
    json.dump(ranked_result_of_ingredient_goodfood(), open('/datasets/ingredients_ranking_bbcgoodfood.json','w'))
...
def write_ranking_result_overall():
    json.dump(ranked_result_of_ingredient_overall(), open('/datasets/ingredients_ranking_overall.json','w'))
